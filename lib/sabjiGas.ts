...
const EXACT_SABJI_GAS:
  Record<string, SabjiGasSuggestion> = {
    ...
    'gobi matar': suggestion(0.82, 'Dry / Semi Gravy'),
    'hyderabadi baingan': suggestion(1.10, 'Rich Baingan Gravy'),
    'kadai mushroom': suggestion(1.00, 'Kadai Semi Gravy'),
    'kaddu ki sabji': suggestion(0.78, 'Dry / Semi Gravy'),
    'kaju corn masala': suggestion(1.08, 'Rich Semi Gravy'),
    'kaju kofta curry': suggestion(1.50, 'Kofta + Rich Gravy'),
    'kaju korma': suggestion(1.20, 'Rich Gravy'),
    'kaju masala': suggestion(1.15, 'Rich Gravy'),
    'kaju matar': suggestion(1.05, 'Rich Semi Gravy'),
    'kaju mushroom': suggestion(1.10, 'Rich Semi Gravy'),
    'kashmiri dum aloo': suggestion(1.25, 'Dum Gravy'),
    'kathal do pyaza': suggestion(1.00, 'Semi Gravy'),
    'kathal korma': suggestion(1.20, 'Rich Gravy'),
    'kathal masala': suggestion(1.05, 'Semi Gravy'),
    'kathal rogan josh': suggestion(1.20, 'Slow Gravy'),
    'khatta meetha kaddu': suggestion(0.85, 'Dry / Semi Gravy'),
    'kurkuri bhindi': suggestion(1.00, 'Crispy / Fry'),
    'lauki kofta': suggestion(1.25, 'Fried Kofta'),
    'lauki kofta curry': suggestion(1.45, 'Kofta + Gravy'),
    'lauki masala': suggestion(0.90, 'Semi Gravy'),
    'lauki matar': suggestion(0.85, 'Light Semi Gravy'),
    'malai kofta': suggestion(1.50, 'Kofta + Rich Gravy'),
    'malai vegetable curry': suggestion(1.20, 'Cream Gravy'),
    'matar masala': suggestion(0.90, 'Semi Gravy'),
    'matar methi malai': suggestion(1.05, 'Cream Gravy'),
    'matar mushroom': suggestion(0.90, 'Semi Gravy'),
    'methi aloo': suggestion(0.75, 'Dry Leafy Sabji'),
    'methi chaman': suggestion(1.05, 'Leafy Paneer Gravy'),
    'methi matar': suggestion(0.80, 'Leafy Sabji'),
    'mix veg': suggestion(0.85, 'Mixed Sabji'),
    'mix veg curry': suggestion(1.00, 'Mixed Gravy'),
    'mushroom chettinad': suggestion(1.05, 'Spiced Gravy'),
    'mushroom corn masala': suggestion(1.00, 'Semi Gravy'),
    'mushroom do pyaza': suggestion(0.95, 'Semi Gravy'),
    'mushroom handi': suggestion(1.05, 'Handi Gravy'),
    'mushroom kaju masala': suggestion(1.10, 'Rich Semi Gravy'),
    'mushroom kali mirch': suggestion(1.00, 'Pepper Gravy'),
    'mushroom makhanwala': suggestion(1.10, 'Butter Gravy'),
    'mushroom malai curry': suggestion(1.15, 'Cream Gravy'),
    'mushroom palak': suggestion(0.95, 'Leafy Gravy'),
    'nargisi veg kofta': suggestion(1.50, 'Kofta + Rich Gravy'),
    'palak aloo': suggestion(0.85, 'Leafy Sabji'),
    'palak chana': suggestion(1.00, 'Leafy + Legume'),
    'palak corn': suggestion(0.90, 'Leafy Gravy'),
    'palak kofta': suggestion(1.35, 'Fried Kofta + Leafy'),
    'palak kofta curry': suggestion(1.45, 'Kofta + Leafy Gravy'),
    'palak mushroom': suggestion(0.95, 'Leafy Gravy'),
    'paneer kofta curry': suggestion(1.50, 'Paneer Kofta + Gravy'),
    'parwal masala': suggestion(0.85, 'Dry / Semi Gravy'),
    'pumpkin masala': suggestion(0.85, 'Dry / Semi Gravy'),
    'punjabi dum aloo': suggestion(1.20, 'Dum Gravy'),
    'puri bhaji': suggestion(1.00, 'Bhaji + Fry Service'),
    'raw banana fry': suggestion(0.85, 'Dry / Fry'),
    'raw banana masala': suggestion(0.95, 'Semi Gravy'),
    'sarson ka saag': suggestion(1.20, 'Slow Cooked Leafy'),
    'shahi kofta curry': suggestion(1.55, 'Kofta + Rich Gravy'),
    'shahi vegetable curry': suggestion(1.20, 'Rich Gravy'),
    'subz bahar': suggestion(1.05, 'Mixed Gravy'),
    'subz miloni': suggestion(1.05, 'Mixed Gravy'),
    'subz panchratna': suggestion(1.10, 'Rich Mixed Gravy'),
    'tawa sabji': suggestion(1.10, 'Tawa Finish'),
    'tinda masala': suggestion(0.85, 'Dry / Semi Gravy'),
    'turai chana dal': suggestion(1.00, 'Dal + Sabji'),
    'turai masala': suggestion(0.85, 'Light Semi Gravy'),
    'veg diwani handi': suggestion(1.10, 'Handi Gravy'),
    'veg hyderabadi': suggestion(1.10, 'Rich Gravy'),
    'veg jaipuri': suggestion(1.10, 'Rich Gravy'),
    'veg kadai': suggestion(1.05, 'Kadai Semi Gravy'),
    'veg kofta curry': suggestion(1.45, 'Kofta + Gravy'),
    'veg makhanwala': suggestion(1.15, 'Butter Gravy'),
    'veg mughlai': suggestion(1.20, 'Rich Gravy'),
    'vegetable do pyaza': suggestion(0.95, 'Semi Gravy'),
    'vegetable khurchan': suggestion(1.10, 'Tawa / Khurchan'),
    'vegetable korma': suggestion(1.20, 'Rich Gravy'),
    'vegetable lababdar': suggestion(1.15, 'Rich Gravy'),
    'vegetable lahori': suggestion(1.15, 'Rich Gravy'),
    'vegetable tawa masala': suggestion(1.10, 'Tawa Finish'),
    'chana masala': suggestion(1.10, 'Legume Gravy'),
    'matar paneer': suggestion(1.10, 'Paneer Gravy'),
    'chole masala': suggestion(1.15, 'Legume Gravy'),
    'cheese paneer patiala': suggestion(1.20, 'Rich Paneer Gravy'),
    'paneer cheese butter masala': suggestion(1.25, 'Rich Paneer Butter Gravy'),
    'aloo gobi': suggestion(0.80, 'Dry / Semi Gravy'),
    'mix chilli milli sabji': suggestion(1.00, 'Mixed Semi Gravy'),
  };
